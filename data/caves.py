...
class Cave:
    ...
    _caves = [
        ...
        },
        {
            ...
            'level_requirement': 0,
            'exp': 3,
            'drop_odds': [0.2, 0.35, 0.25, 0.10, 0.10],
            Rarity.COMMON: [(Drop.GOLD, 1)],
            Rarity.RARE: [(Drop.GOLD, 5)],
            Rarity.EPIC: [(Drop.GOLD, 25)],
            Rarity.LEGENDARY: [(Drop.GOLD, 100), (Drop.EQUIPMENT, 1100), (Drop.EQUIPMENT, 7000)],
            'current_quantity': -1,
            'max_quantity': -1,
        },
        {
            ...
            'level_requirement': 2,
            'exp': 5,
            'drop_odds': [0.2, 0.36, 0.3, 0.09, 0.05],
            Rarity.COMMON: [(Drop.GOLD, 1)],
            Rarity.RARE: [(Drop.GOLD, 5)],
            Rarity.EPIC: [(Drop.GOLD, 25), (Drop.EQUIPMENT, 1100), (Drop.EQUIPMENT, 7000)],
            Rarity.LEGENDARY: [(Drop.GOLD, 100), (Drop.EQUIPMENT, 1200), (Drop.EQUIPMENT, 7001)],
            'current_quantity': -1,
            'max_quantity': -1,
        },
        {
            ...
            Rarity.COMMON: [(Drop.GOLD, 1)],
            Rarity.RARE: [(Drop.GOLD, 5)],
            Rarity.EPIC: [(Drop.GOLD, 25), (Drop.EQUIPMENT, 1200), (Drop.EQUIPMENT, 7001)],
            Rarity.LEGENDARY: [(Drop.GOLD, 100), (Drop.EQUIPMENT, 1200), (Drop.EQUIPMENT, 7001)],
            'current_quantity': -1,
            'max_quantity': -1,
        },
        {
            ...
            'exp': 15,
            'drop_odds': [0.67, 0.10, 0.08, 0.10, 0.05],
        ...
        },
        {
            ...
            'exp': 6,
            'drop_odds': [0.37, 0.3, 0.20, 0.08, 0.05],
        ...
        },
        {
            ...
            'exp': 20,
            'drop_odds': [0.39, 0.3, 0.20, 0.10, 0.01],
        ...
        },
        {
            ...
            'exp': 25,
            'drop_odds': [0.375, 0.3, 0.20, 0.10, 0.025],
            Rarity.COMMON: [(Drop.GOLD, 5)],
            Rarity.RARE: [(Drop.GOLD, 13)],
        ...
        },
        {
            ...
            Rarity.LEGENDARY: [(Drop.GOLD, 5000), (Drop.EXP, 2500), (Drop.EQUIPMENT, 1500), (Drop.EQUIPMENT, 7020)],
            'current_quantity': 10000,
            'max_quantity': 10000,
        },
        {
        ...
        },
        {
            ...
            'drop_odds': [0.4, 0.3, 0.20, 0.09, 0.01],
            Rarity.COMMON: [(Drop.EXP, 500)],
            Rarity.RARE: [(Drop.EXP, 700)],
            Rarity.EPIC: [(Drop.GOLD, 500)],
            Rarity.LEGENDARY: [(Drop.GOLD, 25000), (Drop.EQUIPMENT, 2200)],
            'current_quantity': 10000,
            'max_quantity': 10000,
        },
    ]
